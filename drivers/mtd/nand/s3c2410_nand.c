				      ...
				      u_char *ecc_code)
{
	...
	ecc_code[0] = (u_char)(nand->nfeccd0);
        ecc_code[1] = (u_char)((nand->nfeccd0) >> 16);
        ecc_code[2] = (u_char)(nand->nfeccd1);
	ecc_code[3] = (u_char)((nand->nfeccd1) >> 16);
...
int board_nand_init(struct nand_chip *nand)
{
	...
	/* cfg = (readl(&nand_reg->nfcont)|S3C2410_NFCONT_EN); */
